 ...
 */
package com.github.crashdemons.wglecternflags;
 ...
 * @author crash
 */
public class WGLecternFlags extends JavaPlugin implements Listener {
    WorldGuardPlugin wgp = null;
    WorldGuard wg = null;
    
    
    
    public static final StateFlag FLAG_LECTERN_TAKE = new StateFlag("lectern-take", true);
    public static final StateFlag FLAG_LECTERN_TAKE_WARNING = new StateFlag("lectern-take-warning", true);
    ...
    public void onLecternTake(PlayerTakeLecternBookEvent event){
        ...
        Location loc = lectern.getLocation();
